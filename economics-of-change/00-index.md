# Economics of Change — index

Purpose: build a durable lens for evaluating whether a social-change initiative's economics will hold — before committing capital, not after. Personal 5-6 year project, run alongside `../problems/` but not nested under it: `problems/` rederives *what's broken*; this asks *what funding/ownership structure makes a fix survive*.

Started 2026-07-31, prompted by a working question: why is social change underfunded and why do well-meant interventions sometimes cause net damage.
