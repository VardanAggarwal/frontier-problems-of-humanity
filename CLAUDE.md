...
problems/
  ...
  actors/_excluded.yaml            names ruled out for good — the crawler skips these; `npm run exclude`
  actors/_crawl-state.md           impact-network-crawler's handover between passes — leads, edges, prunes, dead ends
